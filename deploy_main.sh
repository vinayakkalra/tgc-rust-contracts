...
dfx canister stop tgc_rust --network ic || true
dfx canister delete tgc_rust --yes --no-withdrawal --network ic || true
dfx deploy --argument "record{payment_recipient= principal \"$RECIEVER\"}" tgc_rust --network ic